        ...
        <div class="container-max section-padding">
            <div class="flex flex-wrap items-center justify-between gap-4 py-4">
                ...
                <div class="flex items-center gap-4">
                    <img src="{{ asset('storage/logo.png') }}" alt="لوگوی سایت" class="w-12 h-12 rounded-full object-cover shadow-md ring-1 ring-gray-200">
                    <div class="text-right">
                        <h1 class="text-2xl font-bold text-gray-900 leading-tight">سامانه نظرسنجی</h1>
                    </div>
                </div>
                ...
                <div class="text-center lg:text-right">
                    ...
                    <div class="slide-in-left">
                        <p class="text-xl lg:text-2xl text-white/90 mb-8 leading-relaxed">
                            ...
                            سامانه نظرسنجی پاریز امکان دریافت و تحلیل نظرات تیم‌ها را در یک بستر واحد فراهم می‌کند.
